// Copyright Apple
// Source: https://github.com/DougGregor/swift/blob/380bad4e0743d2b6e1d1b23ee2b02bba04ac9a3d/test/Macros/macro_expand_body.swift
...
// RESTORE: infinite recursion; log2 invisible
// @Log2
public func log2(_ value: String) {
  print("log2(\(value))")
}
